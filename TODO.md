...
- `GET /api/inventory/{productId}` should return configured flash-sale stock, Redis-backed remaining stock, flash-sale price, and active window in a shape a frontend can render directly.
